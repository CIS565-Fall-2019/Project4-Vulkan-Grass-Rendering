...
void Renderer::CreateComputeDescriptorSetLayout() {
    ...
    std::vector<VkDescriptorSetLayoutBinding> bindings = { inputLayoutBinding, culledLayoutBinding, numLayoutBinding };
...
void Renderer::CreateComputeDescriptorSets() {
    ...
    for (uint32_t i = 0; i < scene->GetBlades().size(); ++i) {
        ...
        computeIndirectBufferInfo.offset = 0;
        computeIndirectBufferInfo.range = sizeof(BladeDrawIndirect);
        ...
        descriptorWrites[3 * i + 0].pBufferInfo = &computeInputBufferInfo;
        ...
        descriptorWrites[3 * i + 1].pBufferInfo = &computeCulledBufferInfo;
        ...
        descriptorWrites[3 * i + 2].pBufferInfo = &computeIndirectBufferInfo;
